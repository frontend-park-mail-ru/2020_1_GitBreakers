...
import {NEWPULLREQUEST, UPLOAD, ACTIONS, REPOSITORY, HEADER} from 'Modules/events';
...
export default class NewPullRequestController extends RepositoryController {
  ...
  async _getRepository() {
    ...
    const result = await RepositoryModel.loadRepository({repName : repName, author : author});
